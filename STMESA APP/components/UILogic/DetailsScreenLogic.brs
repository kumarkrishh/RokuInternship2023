...
sub ShowDetailsScreen(content as Object, selectedItem as Integer, selectedColumn as Integer)
    if selectedItem < 1
    ' create new instance of details screen
        detailsScreen = CreateObject("roSGNode", "MerchScreen")
        detailsScreen.content = content
        detailsScreen.jumpToItem = selectedColumn ' set index of item which should be focused
...
sub HandlePlayButton(content as Object, selectedItem as Integer)
        ...
        if itemContent.mediaType = "MESA Videos"
