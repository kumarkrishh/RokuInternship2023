...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `kumarkrishh`, `RokuInternship2023`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `project_title`, `project_description`
...
([Roku SceneGraph](https://developer.roku.com/docs/developer-program/getting-started/hello-world.md))
...
See the [open issues](https://github.com/kumarkrishh/RokuInternship2023/issues) for a full list of proposed features (and known issues).
...
Project Link: [https://github.com/kumarkrishh/RokuInternship2023](https://github.com/kumarkrishh/RokuInternship2023)
